<h2>Xin chào {{$user_name}}! Cảm ơn bạn đã đặt hàng tại ROSECosmetics.</h2>
<p>
	<b>Đơn hàng của bạn đã được đặt thành công</b>
</p>
<h4>Thông tin đơn hàng của bạn</h4>
<h4>Mã Đơn Hàng: {{$order->order_code}}</h4>
<h4>Ngày Đặt Hàng: {{$order->created_at}}</h4>
<h4>Giao Hàng Dự kiến: {{$order->delivery_date}}</h4>
